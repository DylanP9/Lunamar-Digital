...
export default function PageHero({
  ...
  return (
    <section className="relative overflow-hidden pt-36 pb-16 sm:pt-40 sm:pb-20">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-0 h-80 w-[44rem] max-w-full -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(127,163,255,0.16),rgba(52,97,255,0.08)_45%,transparent_70%)] blur-2xl"
      />
