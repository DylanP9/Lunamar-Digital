      ...
      <div className="container-x">
        <Reveal>
          <div className="glow-border relative overflow-hidden rounded-[2rem] border border-[var(--color-line-strong)] bg-white/[0.03] px-6 py-16 text-center sm:px-12 sm:py-20">
            <div
              aria-hidden
              className="absolute left-1/2 top-1/2 h-[28rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(127,163,255,0.18),rgba(52,97,255,0.09)_45%,transparent_70%)] blur-2xl animate-pulse-glow"
            />
